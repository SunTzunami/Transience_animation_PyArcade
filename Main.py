...
def draw_bg(u):
        ...
        if(draw_bg.t<0 and draw_bg.end==0):
                ...
                elif(draw_bg.end in range(21, 280)):
                        bg=arcade.load_texture("end/18.png")
                elif(draw_bg.end>=280 and draw_bg.end<290):
                        bg=arcade.load_texture("end/fade/{}.png".format(draw_bg.end%10))
                elif(draw_bg.end>=280):
...
def main():
        s_title="Peace"
        arcade.Window.music = arcade.Sound("whispersway.mp3", streaming=True)
        arcade.open_window(s_width, s_height, s_title)
        arcade.schedule(draw_bg, 1/22)
        arcade.Window.music.play(0.6)
        arcade.run()
main()
#print(draw_bg.t)
